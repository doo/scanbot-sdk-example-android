...
fun Context.getAppStorageDir() = File(this.getExternalFilesDir(null)!!, APP_DATA_FOLDER_NAME)

fun getAppStorageDir(context: Context) = context.getAppStorageDir()
...
fun Context.showToast(message: String) {
    ...
    if (Looper.myLooper() == Looper.getMainLooper()) {
        ...
        if (this@showToast is CoroutineScope) {
            ...
            Log.e("ScanbotSdkShowToast", "Can't show toast from non-UI thread without CoroutineScope!!!")
        }
    }
}
